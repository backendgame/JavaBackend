...
public class DBIndexType_Double extends DBBaseType{
	
	public DBIndexType_Double(RandomAccessFile _rfData, Object object) {
		rfData=_rfData;
		long v =  (long) object;
		data=new byte[8];
		data[0] = (byte)(v >>> 56);
	...
	public DBIndexType_Double(RandomAccessFile _rfData) {
		rfData=_rfData;
	}
	...
	@Override public void writeData(Object object) throws IOException {
		rfData.writeDouble((double) object);	
	}
