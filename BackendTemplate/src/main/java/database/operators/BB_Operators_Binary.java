...
public class BB_Operators_Binary {
...
//			case Add:add(rf, offset, messageReceiving, messageSending);break;
	...
	public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
		rf.seek(offset);
		rf.write((byte[]) operator.Value);
	}
	

	
	private BB_Operators_Binary() {}
	private static BB_Operators_Binary instance=null;
	public static final BB_Operators_Binary gI() {
		if(instance==null) {
			instance = new BB_Operators_Binary();
		}
		return instance;
	}
}
