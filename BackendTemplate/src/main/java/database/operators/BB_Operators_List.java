...
public class BB_Operators_List {
...
//			case Add:add(rf, offset, messageReceiving, messageSending);break;
	...
	
	private BB_Operators_List() {}
	private static BB_Operators_List instance=null;
	public static final BB_Operators_List gI() {
		if(instance==null) {
			instance = new BB_Operators_List();
		}
		return instance;
	}
}
