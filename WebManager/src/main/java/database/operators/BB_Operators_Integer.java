...
public class BB_Operators_Integer {
...
//          case Add:add(rf, offset, messageReceiving, messageSending);break;
    ...
    public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
        rf.seek(offset);
        rf.writeInt((int) operator.Value);
    }
    
    
    private BB_Operators_Integer() {}
    private static BB_Operators_Integer instance=null;
    public static final BB_Operators_Integer gI() {
        if(instance==null) {
            instance = new BB_Operators_Integer();
        }
        return instance;
    }
}