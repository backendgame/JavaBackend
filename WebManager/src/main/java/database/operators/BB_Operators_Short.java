...
public class BB_Operators_Short {
...
//          case Add:add(rf, offset, messageReceiving, messageSending);break;
    ...
    public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
        rf.seek(offset);
        rf.writeShort((short) operator.Value);
    }
    
    
    private BB_Operators_Short() {}
    private static BB_Operators_Short instance=null;
    public static final BB_Operators_Short gI() {
        if(instance==null) {
            instance = new BB_Operators_Short();
        }
        return instance;
    }
}