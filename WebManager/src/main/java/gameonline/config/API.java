...
public class API {
	...
	public static final String LoginScreen_Login_With_EmailPassword = "Login-with-email-password";
	public static final String LoginScreen_Register_GetVerifyCode = "Request-VerifyCode";
	public static final String LoginScreen_Register_CompleteVerifycode = "Complete-VerifyCode";
	public static final String LoginScreen_ForgotPassword_Request = "ForgotPassword-Request";
	public static final String LoginScreen_ForgotPassword_Submit = "ForgotPassword-Submit";
...
//	public static final String TABLERow_QuerryAccount_ByLatest		= "RowQuerryAccount-LatestCreate";
	...
	public static final String SubTable_Create_TilePrimaryKey	= "Create-Tile-PrimaryKey";
	public static final String SubTable_Create_TileBinary		= "Create-Tile-Binary";
	public static final String SubTable_Create_TileRow			= "Create-Tile-Row";
	public static final String SubTable_Rename					= "Rename";
	public static final String SubTable_Config_AccessToken		= "Config-AccessToken";
	public static final String SubTable_Config_ReadToken		= "Config-ReadToken";
	public static final String SubTable_Config_WriteToken		= "Config-WriteToken";
	...
	public static final String Leaderboard_LoadConfig			= "LoadConfig";
