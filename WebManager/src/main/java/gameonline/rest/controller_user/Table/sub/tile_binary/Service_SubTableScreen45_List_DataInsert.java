...
public class Service_SubTableScreen45_List_DataInsert extends BaseAuthorization{
	...
	@Override public MyRespone respone() {
		final MessageSending messageSending = new MessageSending(CMD_ONEHIT.BBWeb_SubTileBinary_Data_Insert);
