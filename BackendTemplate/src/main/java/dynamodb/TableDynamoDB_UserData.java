...
//    public static final String ATTRIBUTE_password = "password";
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public boolean insertPlayer(long userId, long timeTTL, HashMap<String, Object> infoVerifyCode) {
    	try {
    		table.putItem(new Item().withPrimaryKey(HASH_KEY, userId)
				...
				.withMap(ATTRIBUTE_Tiles, new HashMap<>())
   				.withMap(ATTRIBUTE_infomation, infoVerifyCode));
    		return true;
    	}catch (Exception e) {
    		e.printStackTrace();
    		return false;
...
//    				.withExpected(requirementMustExist)
    		...
    		Map<?,?> mapInfo = (Map<?, ?>) item.get(TableDynamoDB_UserData.ATTRIBUTE_infomation);
    		if(mapInfo!=null) {
    ...
    public void completeRegisterWithVerifycode(long userId) {
    	table.updateItem(new PrimaryKey(HASH_KEY, userId)
    			...
    			,new AttributeUpdate(ATTRIBUTE_infomation).delete());    	
    }
