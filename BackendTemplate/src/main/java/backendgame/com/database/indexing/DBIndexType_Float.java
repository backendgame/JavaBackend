...
public class DBIndexType_Float extends DBBaseType{
	
	public DBIndexType_Float(RandomAccessFile _rfData, Object object) {
		rfData=_rfData;
	...
	public DBIndexType_Float(RandomAccessFile _rfData) {
		rfData=_rfData;
	}
	...
	public void writeData(Object object) throws IOException {
		rfData.writeFloat((float) object);
	}
