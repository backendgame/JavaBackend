...
public class BB_Operators_Byte {
    ...
    public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
        rf.seek(offset);
        rf.writeByte((byte)operator.Value);
    }
    
    
    private BB_Operators_Byte() {}
    private static BB_Operators_Byte instance=null;
    public static final BB_Operators_Byte gI() {
        if(instance==null) {
            instance = new BB_Operators_Byte();
        }
        return instance;
    }
}