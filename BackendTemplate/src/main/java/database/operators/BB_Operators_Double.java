...
public class BB_Operators_Double {
...
//			case Add:add(rf, offset, messageReceiving, messageSending);break;
	...
	public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
		rf.seek(offset);
		rf.writeDouble((double) operator.Value);
	}
	
	
	private BB_Operators_Double() {}
	private static BB_Operators_Double instance=null;
	public static final BB_Operators_Double gI() {
		if(instance==null) {
			instance = new BB_Operators_Double();
		}
		return instance;
	}
}
