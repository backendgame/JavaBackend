...
public class BB_Operators_Float {
...
//          case Add:add(rf, offset, messageReceiving, messageSending);break;
    ...
    public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
        rf.seek(offset);
        rf.writeFloat((float) operator.Value);
    }
    
    
    private BB_Operators_Float() {}
    private static BB_Operators_Float instance=null;
    public static final BB_Operators_Float gI() {
        if(instance==null) {
            instance = new BB_Operators_Float();
        }
        return instance;
    }
}