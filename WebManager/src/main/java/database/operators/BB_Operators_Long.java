...
public class BB_Operators_Long {
...
//          case Add:add(rf, offset, messageReceiving, messageSending);break;
    ...
    public void set(RandomAccessFile rf, long offset, BB_Operator operator) throws IOException {
        rf.seek(offset);
        rf.writeLong((long) operator.Value);
    }
    
    
    private BB_Operators_Long() {}
    private static BB_Operators_Long instance=null;
    public static final BB_Operators_Long gI() {
        if(instance==null) {
            instance = new BB_Operators_Long();
        }
        return instance;
    }
}