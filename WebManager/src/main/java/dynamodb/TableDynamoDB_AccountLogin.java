...
public class TableDynamoDB_AccountLogin {
    public static final String TABLE_NAME = "BackendGame_AccountLogin";
    ...
    public static final String ATTRIBUTE_Timeout_ForgotPassword = "TimeForgotPassword";
	...
	public void changePassword(String email, String password) {
		table.updateItem(new PrimaryKey(HASH_KEY, email)
				,new AttributeUpdate(ATTRIBUTE_password).put(password)
				,new AttributeUpdate(ATTRIBUTE_Timeout_ForgotPassword).delete());
	}
